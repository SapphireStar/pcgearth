...
// Called every frame
void UPlanetaryMovementComponent::TickComponent(float DeltaTime, ELevelTick TickType,
...
void UPlanetaryMovementComponent::UpdateGravityDirection(const FVector& GravityDir)
{
